...
class DeclarationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create declaration" do
    assert_difference('Declaration.count') do
      post declarations_url, params: { declaration: { declaration_name: @declaration.declaration_name, description: @declaration.description } }
    end
  ...
  test "should update declaration" do
    patch declaration_url(@declaration), params: { declaration: { declaration_name: @declaration.declaration_name, description: @declaration.description } }
